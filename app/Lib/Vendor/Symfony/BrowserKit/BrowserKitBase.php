 ...
 * --------------------------------------------------------------------------
 * 
 * Vendor contents as base for extensions.  
 * Contents src : /vendor/symfony/browser-kit/Client.php
 * Contents namespace : Symfony\Component\BrowserKit\Client
 *  
 * updates & extensions marked with @extension
 */
...
/**
 * Base BrowserKit Trait. 
 * BrowserKit client contents as base for extensions. 
 * 
 */
trait BrowserKitBase
{
    protected $history;
    protected $cookieJar;
    ...
    public function request(string $method, string $uri, array $parameters = array(), array $files = array(), array $server = array(), string $content = null, bool $changeHistory = true)
    {
        ...
        if (!$this->history->isEmpty()) {
            ...
            //var_dump($this->history->back()->getUri());
